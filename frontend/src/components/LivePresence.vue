  ...
  <div v-if="socketStore.activeOperatives.length > 0" class="flex flex-col gap-3 animate-in fade-in slide-in-from-right-4 duration-500">
    ...
    <Transition name="fade">
      <div v-if="showModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md bg-deep-abyss border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
          <!-- Modal Header -->
              ...
              >
                <div class="flex items-center gap-4">
                  <div class="relative">
                    ...
                    <div class="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 rounded-full flex items-center justify-center border-2 border-deep-abyss shadow-lg">
