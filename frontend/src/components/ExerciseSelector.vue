<template>
  <div class="flex flex-wrap gap-2 p-1.5 bg-black/40 backdrop-blur-xl border border-white/5 rounded-2xl">
    <button 
      ...
      :class="modelValue === ex.id 
        ? 'bg-primary-600 text-white shadow-lg shadow-primary-900/40 scale-105' 
