...
const RARITY_LABELS = { es: { common: 'Común', rare: 'Rara', especial: 'Especial', legendary: 'Legendaria', calistenico: 'Calisténica', cosmico: 'Cósmica' }, en: { common: 'Common', rare: 'Rare', especial: 'Special', legendary: 'Legendary', calistenico: 'Calisthenic', cosmico: 'Cosmic' } };

function rarityColor(r) { return RARITY_COLORS[r] || '#9ca3af'; }
function rarityLabel(r) { return (RARITY_LABELS[locale.value] || RARITY_LABELS.es)[r] || r || ''; }
