export default {
    ...
    inv_title: 'Armería',
    inv_subtitle: 'Estado de élite y gestión de equipo',
    inv_tab_combat: 'Protocolo de Combate',
    inv_tab_customization: 'Identidad y Estilo',
    inv_total_power: 'Potencia Total',
    inv_gear_mod: 'Modificador de Equipo',
    inv_slot_helmet: 'Casco',
    ...
    inv_crit_prob: 'Probabilidad Crítica',
