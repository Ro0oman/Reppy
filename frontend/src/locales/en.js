export default {
    ...
    plan_first_pullup_desc: '21 days to build pulling strength from zero.',
    plan_five_pullups_title: 'My first 5 pull-ups',
    plan_five_pullups_desc: 'Turn single reps into solid sets.',
    plan_ten_pullups_title: 'My first 10 pull-ups',
    plan_ten_pullups_desc: 'Build volume without training blind.',
    plan_twenty_pushups_title: 'First 20 push-ups',
    plan_twenty_pushups_desc: 'Push strength, control, and consistency.',
    ...
    onboarding_goal_guided_desc: 'Reppy guides me with daily workouts.',
