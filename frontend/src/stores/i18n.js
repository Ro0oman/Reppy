...
const translations = {
  en: {
    ...
    codex_int_desc: 'Training efficiency. Improves the Global Level multiplier. Earned by reading blog articles.',
    codex_int_action: 'Read tactical guides in the blog.',

    codex_fth_name: 'FAITH',
    codex_fth_quote: 'The bar provides, the iron judge.',
    codex_fth_desc: 'Additional Holy Damage. Your participation in past Boss Battles fuels your current aura.',
    codex_fth_action: 'Participate in Boss Battles and community events.',
  ...
  es: {
    ...
    codex_int_desc: 'Eficiencia en el entrenamiento. Mejora el multiplicador de Nivel Global. Se gana leyendo artículos del Blog.',
    codex_int_action: 'Lee guías tácticas en el blog.',

    codex_fth_name: 'FE',
    codex_fth_quote: 'La barra provee, el hierro juzga.',
    codex_fth_desc: 'Daño Sagrado adicional. Tu participación en Boss Battles pasadas alimenta tu aura divina actual.',
    codex_fth_action: 'Participa en Boss Battles y eventos comunitarios.',
    blog_xp_gained: '¡Conocimiento adquirido! +100 INT XP obtenidos.',
